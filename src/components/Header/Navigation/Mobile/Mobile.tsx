      ...
      >
        ...
        >
          ...
          <Transition.Child
            as={React.Fragment}
            enter={twMerge(
              "sm:ease-emphasized-decelerate sm:duration-emphasized-decelerate sm:transform-gpu sm:transition-[opacity,transform]",
            )}
            ...
            leave={twMerge(
              "sm:ease-emphasized-accelerate sm:duration-emphasized-accelerate sm:transform-gpu sm:transition-[opacity,transform]",
            )}
          ...
          >
            <div
              ...
              style={{
                paddingRight: show === true ? scrollbar : 0,
              }}
            >
